...
ActiveRecord::Schema.define(version: 2020_04_23_011334) do
  ...
  create_table "requested_services", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["service_id", "user_id"], name: "index_requested_services_on_service_id_and_user_id", unique: true
  end
  ...
  create_table "services_tags", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["service_id", "tag_id"], name: "index_services_tags_on_service_id_and_tag_id", unique: true
  end
